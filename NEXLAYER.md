# Nexlayer — label-studio

**Live:** [https://relaxed-weasel-label-studio.cloud.nexlayer.ai](https://relaxed-weasel-label-studio.cloud.nexlayer.ai)  
...
**label-studio** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/heartexlabs/label-studio:latest
    path: /
    servicePorts:
    - 8080
    vars:
      ...
      POSTGRE_HOST: label-studio-postgres-service
  - name: postgres
